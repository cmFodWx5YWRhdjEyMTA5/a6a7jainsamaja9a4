 ...
 * SelectionAdapter may be used with a normal RecyclerView.LinearLayoutManager but is meant for use with
 ...
 * aren't aware of the section information and internal state of SelectionAdapter. As such, please
 * use the SelectionAdapter.notify* methods.
 * <p/>
 * SelectionAdapter manages four types of items: TYPE_HEADER, TYPE_ITEM, TYPE_FOOTER and TYPE_GHOST_HEADER.
 ...
 * be ignored by SelectionAdapter subclasses - but it is made externally accessible just in case.
 */
...
public class SelectionAdapter extends RecyclerView.Adapter<SelectionAdapter.ViewHolder> {
	...
	public static class ViewHolder extends RecyclerView.ViewHolder {
		...
		public int getItemViewBaseType() {
			return SelectionAdapter.unmaskBaseViewType(getItemViewType());
		}

		public int getItemViewUserType() {
			return SelectionAdapter.unmaskUserViewType(getItemViewType());
		}
