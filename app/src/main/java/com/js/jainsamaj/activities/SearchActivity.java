...
public class SearchActivity extends AppCompatActivity implements OnApiCallListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
...
//            sdsProfileSearchBanner.setImageBitmap(decodedByte);
    ...
    private void bindHere() {
        ...
        tbTitle.setText(getResources().getString(R.string.nav_menu_search));
        ...
        tvPheight = (TextView) findViewById(R.id.tvPheight);
        tvPCreated = (TextView) findViewById(R.id.tvPCreated);
        tvPLocation = (TextView) findViewById(R.id.tvPLocation);
        tvPEducation = (TextView) findViewById(R.id.tvPEducation);
        tvPlife = (TextView) findViewById(R.id.tvPlife);
        tvPBodyType = (TextView) findViewById(R.id.tvPBodyType);
        tvPSkinTone = (TextView) findViewById(R.id.tvPSkinTone);
        tvPDisability = (TextView) findViewById(R.id.tvPDisability);


        etPSAgeFrom = (EditText) findViewById(R.id.etPSAgeFrom);
//        etPSAgeFrom.setText("0");
        etPSAgeTo = (EditText) findViewById(R.id.etPSAgeTo);
//        etPSAgeTo.setText("0");
        etPSHeightFrom = (EditText) findViewById(R.id.etPSHeightFrom);
//        etPSHeightFrom.setText("0");
        etPSHeightTo = (EditText) findViewById(R.id.etPSHeightTo);
//        etPSHeightTo.setText("0");
        etPSMStatus = (EditText) findViewById(R.id.etPSMStatus);
        etPSCountry = (EditText) findViewById(R.id.etPSCountry);
        etPSState = (EditText) findViewById(R.id.etPSState);
        etPSCity = (EditText) findViewById(R.id.etPSCity);


        etPSPLevel = (EditText) findViewById(R.id.etPSPLevel);
        etPSPArea = (EditText) findViewById(R.id.etPSPArea);
        etPSPWork = (EditText) findViewById(R.id.etPSPWork);
        etPSWorkAs = (EditText) findViewById(R.id.etPSWorkAs);
        etPSPAnnual = (EditText) findViewById(R.id.etPSPAnnual);


        cbPSTCBy1 = (CheckBox) findViewById(R.id.cbPSTCBy1);
        cbPSTCBy2 = (CheckBox) findViewById(R.id.cbPSTCBy2);
        cbPSTCBy3 = (CheckBox) findViewById(R.id.cbPSTCBy3);
        cbPSTCBy4 = (CheckBox) findViewById(R.id.cbPSTCBy4);

        cbPBType1 = (CheckBox) findViewById(R.id.cbPBType1);
        cbPBType2 = (CheckBox) findViewById(R.id.cbPBType2);
        cbPBType3 = (CheckBox) findViewById(R.id.cbPBType3);
        cbPBType4 = (CheckBox) findViewById(R.id.cbPBType4);

        cbPSTone1 = (CheckBox) findViewById(R.id.cbPSTone1);
        cbPSTone2 = (CheckBox) findViewById(R.id.cbPSTone2);
        cbPSTone3 = (CheckBox) findViewById(R.id.cbPSTone3);
        cbPSTone4 = (CheckBox) findViewById(R.id.cbPSTone4);

        cbDisability1 = (CheckBox) findViewById(R.id.cbDisability1);
        cbDisability2 = (CheckBox) findViewById(R.id.cbDisability2);

        btnPSSave = (Button) findViewById(R.id.btnPSSave);

        sdsProfileSearchBanner = (SimpleDraweeView) findViewById(R.id.sdsProfileSearchBanner);
        sdsProfileSearchBanner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iCompanyUrl = new Intent(SearchActivity.this, WebsiteActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.etPSCountry:
                Intent iTCounty = new Intent(this, SelectionActivity.class);
            ...
            case R.id.etPSState:
                if (CountryId != null) {
                    ...
                    Intent iTState = new Intent(this, SelectionActivity.class);
                    iTState.putExtra("isTState", true);
                    iTState.putExtra("country", id);
                    startActivityForResult(iTState, REQUEST_TEMPLE_STATE);
                } else {
                    AppDialog.showAlertDialog(this, null, getResources().getString(R.string.add_temple_country_error),
            ...
            case R.id.etPSCity:
                if (DistrictId != null) {
                    ...
                    AppDialog.showAlertDialog(this, null, getResources().getString(R.string.error_record_not_available),
                            getString(R.string.txt_ok), new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    dialogInterface.dismiss();
  ...
  /*public UpdateMatrimonyCriteriaMain(int id, String createdUser, int userId, int ageFrom,
                ...
                this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if ((requestType == Api.MainUrl + Api.ActionGetMatrimonyCriteria) && apiResponseMessage.getStatus() == Api.ResponseOk) {
                            ...
                            AppDialog.showAlertDialog(SearchActivity.this, null, apiResponseMessage.getMessage(),
                                    getString(R.string.txt_ok), new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            boolean isListUpdate = true;
                                            dialogInterface.dismiss();
                                            Intent intent = new Intent();
                                            intent.putExtra("isListUpdate",true);
    ...
    public void onFailure(final String errorMessage) {
        ...
        this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                AppDialog.showAlertDialog(SearchActivity.this, null, errorMessage,
                        getString(R.string.txt_ok), new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                dialogInterface.dismiss();
